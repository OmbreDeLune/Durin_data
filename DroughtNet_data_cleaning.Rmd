...
traits <- c("plant_height", "mean_thickness", "SLA", "LDMC") # Add or modify trait names as needed
...
view(droughtnet_data)
#this code is converting the data set to NAs, havent figured out why?

# Write the cleaned data to a new CSV file in the current working directory
write.csv(droughtnet_data, "droughtnet_data_cleaned1.csv", row.names = FALSE)
