...
levels(lygra_data$ageClass)
lygra_data$ageClass <- factor(lygra_data$ageClass, levels = c("Pioneer", "Mature"))
levels(lygra_data$ageClass)
...
emm_ldmc_df <- summary(emm_ldmc) %>%
  as.data.frame() %>%
  mutate(species = recode(species, "Calluna vulgaris" = "CV", "Vaccinium myrtillus" = "VM", "Empetrum nigrum" = "EN", "Vaccinium vitis-idaea" = "VV"))
...
p1 <- ggplot(lygra_data, aes(x = species, y = LDMC, fill = DroughtTrt)) +
  geom_boxplot(position = position_dodge(width = 0.75)) +
  geom_point(data = emm_ldmc_df, aes(x = species, y = emmean, color = DroughtTrt, group = interaction(DroughtTrt, species, ageClass)), position = position_dodge(width = 0.75), size = 1.5) +
  geom_text(data = annotations, aes(x = species, y = y_position, label = label), position = position_dodge(width = 0.75), size = 3.5, fontface = "bold", vjust = -0.5) +
  ...
  labs(x = "Species", y = "LDMC", fill = "Drought Treatment", color = "Drought Treatment") +
  scale_fill_manual(name = "Drought Treatment", values = c("Amb (0)" = "grey", "Ext (90)" = "skyblue"), labels = c("Amb (0)" = "Ambient", "Ext (90)" = "Extreme Drought")) +
  scale_color_manual(name = "Drought Treatment", values = c("Amb (0)" = "black", "Ext (90)" = "black"), labels = c("Amb (0)" = "Ambient", "Ext (90)" = "Extreme Drought"))

# Print the plot
print(p1)
ggsave("LDMC_plot_adjusted.png", plot = p1, width = 7, height = 5, dpi = 300)
...
p2 <- ggplot(lygra_data, aes(x = species, y = log(SLA), fill = DroughtTrt)) +
...
print(p2)
# Save the plot
ggsave("sla_plot_adjusted.png", plot = p2, width = 7, height = 5, dpi = 300)
...
p3 <- ggplot(lygra_data, aes(x = species, y = log(plant_height), fill = DroughtTrt)) +
  geom_boxplot(position = position_dodge(width = dodge_width)) +
...
ggsave("height_plot_adjusted.png", plot = p3, width = 7, height = 5, dpi = 300)
...
y_positions <- lygra_data %>%
  group_by(species, DroughtTrt, ageClass) %>%
  summarize(y_position = max(mean_thickness) * 1.05, .groups = 'drop') 

# Merge annotation labels with their y positions
annotations <- merge(annotations, y_positions, by = c("species", "DroughtTrt", "ageClass"))

p4 <- ggplot(lygra_data, aes(x = species, y = mean_thickness, fill = DroughtTrt)) +
  geom_boxplot(position = position_dodge(width = dodge_width)) +
...
ggsave("thickness_plot_adjusted.png", plot = p4, width = 7, height = 5, dpi = 300)
...
y_positions <- lygra_data %>%
  group_by(species, DroughtTrt, ageClass) %>%
  summarize(y_position = max(leaf_area_transformed) * 1.1, .groups = "drop") 

annotations <- merge(annotations, y_positions, by = c("species", "DroughtTrt", "ageClass"))

p5 <- ggplot(lygra_data, aes(x = species, y = leaf_area_transformed, fill = DroughtTrt)) +
  geom_boxplot(position = position_dodge(width = dodge_width)) +
  ...
  theme(axis.text.x = element_text(angle = 0, hjust = 1, size = 14, face = "bold"),
        ...
        axis.title.y = element_text(size = 14, face = "bold"),
        strip.text = element_text(size = 12, face = "bold"),
        legend.position = "none") + # This line removes the legends
  labs(x = "Species",
       y = "Log (Leaf area (cm²))",
       fill = "Drought Treatment", color = "Drought Treatment") +
  scale_fill_manual(name = "Drought Treatment", 
...
ggsave("area_plot_adjusted.png", plot = p5, width = 7, height = 5, dpi = 300)

```


```{r}
p1 <- p1 + annotate("text", x = Inf, y = Inf, label = "(a)", hjust = 1.1, vjust = 1.1, size = 5, fontface = "bold")
p3 <- p3 + annotate("text", x = Inf, y = Inf, label = "(e)", hjust = 1.1, vjust = 1.1, size = 5, fontface = "bold")
p4 <- p4 + annotate("text", x = Inf, y = Inf, label = "(c)", hjust = 1.1, vjust = 1.1, size = 5, fontface = "bold")
p5 <- p5 + annotate("text", x = Inf, y = Inf, label = "(d)", hjust = 1.1, vjust = 1.1, size = 5, fontface = "bold")
p2 <- p2 + annotate("text", x = Inf, y = Inf, label = "(b)", hjust = 1.1, vjust = 1.1, size = 5, fontface = "bold")

empty_plot <- ggplot() + 
  theme_void() +
  theme(plot.margin = margin(0, 0, 0, 0, "cm"),
        plot.background = element_rect(fill = "transparent", colour = NA),  # Hide plot border
        panel.background = element_rect(fill = "transparent", colour = NA))  # Ensure panel is transparent


library(cowplot)

# Assuming p1, p2, p3, and p4 are your ggplot objects
combined_plotA <- plot_grid(
  p1, p2,
  p4, p5,
  p3, empty_plot,
...
combined_plotB <- plot_grid(
  p3, empty_plot, 
  ncol = 2, 
  align = 'v'
)
ggsave("combined_plotA.pdf", combined_plotA, bg = "transparent", width = 9, height = 12)
...
# Adjusting ageClass in the main dataset
tjøtta_data$ageClass <- gsub("Mature", "M", tjøtta_data$ageClass)
tjøtta_data$ageClass <- gsub("Pioneer", "P", tjøtta_data$ageClass)
view(tjøtta_data)
```
...
# Convert EMMs to a dataframe for plotting
emm_ldmc_df_tj <- summary(emm_ldmc_tj) %>%
  as.data.frame() %>%
  mutate(species = recode(species, "Calluna vulgaris" = "CV", "Vaccinium myrtillus" = "VM", "Empetrum nigrum" = "EN", "Vaccinium vitis-idaea" = "VV"))
...
annotations <- annotations %>%
  mutate(label = case_when(
    ageClass == "Pioneer" & species == "CV" ~ "f",
    ageClass == "Pioneer" & species == "EN" ~ "g",
    ageClass == "Pioneer" & species == "VM" ~ "h",
    ageClass == "Pioneer" & species == "VV" ~ "i",
    ageClass == "Mature" & species == "CV"  & DroughtTrt == "Amb (0)" ~ "a",
    ageClass == "Mature" & species == "CV"  & DroughtTrt == "Ext (90)" ~ "b",
    ageClass == "Mature" & species == "EN" ~ "c",
    ageClass == "Mature" & species == "VM" ~ "d",
    ageClass == "Mature" & species == "VV" ~ "e",
    TRUE ~ NA_character_  
  ))

tjøtta_data <- tjøtta_data %>%
  mutate(species = recode(species, "Calluna vulgaris" = "CV", "Vaccinium myrtillus" = "VM", "Empetrum nigrum" = "EN", "Vaccinium vitis-idaea" = "VV"))

# Calculate the y position for annotations
y_positions <- tjøtta_data %>%
  group_by(species, DroughtTrt, ageClass) %>%
  summarize(y_position = max(LDMC) * 1.05, .groups = "drop")
...
# Creating the plot
p6 <- ggplot(tjøtta_data, aes(x = species, y = LDMC, fill = DroughtTrt)) +
  geom_boxplot(position = position_dodge(width = 0.75)) +
  geom_point(data = emm_ldmc_df_tj, aes(x = species, y = emmean, color = DroughtTrt, group = interaction(DroughtTrt, species, ageClass)), position = position_dodge(width = 0.75), size = 1.5) +
  geom_text(data = annotations, aes(x = species, y = y_position, label = label), position = position_dodge(width = 0.75), size = 3.5, fontface = "bold", vjust = -0.5) +
  facet_wrap(~ ageClass, scales = "free") +
  theme_bw() +
  theme(axis.text.x = element_text(angle = 0, hjust = 1, size = 14, face = "bold"), axis.text.y = element_text(size = 14, face = "bold"), axis.title.x = element_text(size = 14, face = "bold"), axis.title.y = element_text(size = 14, face = "bold"), legend.text = element_text(size = 12), legend.title = element_text(size = 14, face = "bold"), strip.text = element_text(size = 12, face = "bold")) +
  labs(title = "LDMC variability", x = "Species", y = "LDMC", fill = "Drought Treatment", color = "Drought Treatment") +
  scale_fill_manual(name = "Drought Treatment", values = c("Amb (0)" = "grey", "Ext (90)" = "skyblue"), labels = c("Amb (0)" = "Ambient", "Ext (90)" = "Extreme Drought")) +
  scale_color_manual(name = "Drought Treatment", values = c("Amb (0)" = "black", "Ext (90)" = "black"), labels = c("Amb (0)" = "Ambient", "Ext (90)" = "Extreme Drought"))

# Print the plot
print(p6)
ggsave("LDMCtj_plot_adjusted.png", plot = p6, width = 7, height = 5, dpi = 300)
...
# Calculate estimated marginal means for the interaction
emm_htj <- emmeans(tj_height_s_d_a, ~ DroughtTrt * species * ageClass)

# Convert EMMs to a dataframe for plotting
emm_height_df <- summary(emm_htj) %>%
  as.data.frame() %>%
  mutate(species = recode(species,
                          "Calluna vulgaris" = "CV",
                          "Vaccinium myrtillus" = "VM",
...
p7 <- ggplot(tjøtta_data, aes(x = species, y = log(plant_height), fill = DroughtTrt)) +
  geom_boxplot(position = position_dodge(width = dodge_width)) +
  geom_point(data = emm_height_df, aes(x = species, y = emmean, color = DroughtTrt, group = interaction(DroughtTrt, species, ageClass)),
             position = position_dodge(width = dodge_width), size = 1.5) +
  facet_wrap(~ ageClass, scales = "free") +
...
ggsave("heighttj_plot_adjusted.png", plot = p7, width = 7, height = 5, dpi = 300)
...
# Calculate estimated marginal means for the interaction
emm_slatj <- emmeans(tj_sla_s_d_a, ~ DroughtTrt * species * ageClass)

# Convert EMMs to a dataframe for plotting
emm_sla_df <- summary(emm_slatj) %>%
  as.data.frame() %>%
  mutate(species = recode(species,
                          "Calluna vulgaris" = "CV",
                          "Vaccinium myrtillus" = "VM",
...
p8 <- ggplot(tjøtta_data, aes(x = species, y = log(SLA), fill = DroughtTrt)) +
  geom_boxplot(position = position_dodge(width = dodge_width)) +
  geom_point(data = emm_sla_df, aes(x = species, y = emmean, color = DroughtTrt, group = interaction(DroughtTrt, species, ageClass)),
             position = position_dodge(width = dodge_width), size = 1.5) +
  facet_wrap(~ ageClass, scales = "free") +
...
print(p8)
# Save the plot
ggsave("slatj_plot_adjusted.png", plot = p8, width = 7, height = 5, dpi = 300)
...
# Calculate estimated marginal means for the interaction
emm_thickness <- emmeans(tj_t_s_d_a, ~ DroughtTrt * species * ageClass)
...
p9 <- ggplot(tjøtta_data, aes(x = species, y = mean_thickness, fill = DroughtTrt)) +
  geom_boxplot(position = position_dodge(width = dodge_width)) +
  geom_point(data = emm_thickness_df, aes(x = species, y = emmean, color = DroughtTrt, group = interaction(DroughtTrt, species, ageClass)),
             position = position_dodge(width = dodge_width), size = 1.5) +
  facet_wrap(~ ageClass, scales = "free") +
  ...
  geom_text(data = annotations, aes(x = species, y = y_position, label = label),
            position = position_dodge(width = dodge_width), size = 3.5, fontface = "bold", vjust = 0)  
print(p9)
ggsave("thicknesstj_plot_adjusted.png", plot = p9, width = 7, height = 5, dpi = 300)
```
...
```{r}
#use log plus 1 transformation because leaf area has values which are almost zero
tjøtta_data$leaf_area_transformed <- log(tjøtta_data$leaf_area + 1)

tj_area_s_d_a <- lmer(leaf_area_transformed ~ DroughtTrt * species * ageClass +
                                    (1 | DroughNet_plotID), 
                                  data = tjøtta_data)
...
emm_a <- emmeans(tj_area_s_d_a, ~ DroughtTrt * species * ageClass)
...
annotations <- annotations %>%
  mutate(label = case_when(
    ageClass == "Pioneer" & species == "CV" ~ "g",
    ageClass == "Pioneer" & species == "EN" ~ "h",
    ageClass == "Pioneer" & species == "VM" & DroughtTrt == "Amb (0)" ~ "i",
    ageClass == "Pioneer" & species == "VM" & DroughtTrt == "Ext (90)" ~ "j",
    ageClass == "Pioneer" & species == "VV" & DroughtTrt == "Amb (0)" ~ "k",
    ageClass == "Pioneer" & species == "VV" & DroughtTrt == "Ext (90)" ~ "l",
    ageClass == "Mature" & species == "CV" ~ "a",
    ageClass == "Mature" & species == "EN" ~ "b",
    ageClass == "Mature" & species == "VM" & DroughtTrt == "Amb (0)" ~ "c",
    ageClass == "Mature" & species == "VM" & DroughtTrt == "Ext (90)" ~ "d",
    ageClass == "Mature" & species == "VV" & DroughtTrt == "Amb (0)" ~ "e",
    ageClass == "Mature" & species == "VV" & DroughtTrt == "Ext (90)" ~ "f",
    TRUE ~ NA_character_
  ))
...
p10 <- ggplot(tjøtta_data, aes(x = species, y = leaf_area_transformed, fill = DroughtTrt)) +
  geom_boxplot(position = position_dodge(width = dodge_width)) +
  geom_point(data = emm_area_df, aes(x = species, y = emmean, color = DroughtTrt, group = interaction(DroughtTrt, species, ageClass)),
             position = position_dodge(width = dodge_width), size = 1.5) +
  facet_wrap(~ ageClass, scales = "free") +
  ...
  geom_text(data = annotations, aes(x = species, y = y_position, label = label),
            position = position_dodge(width = dodge_width), size = 3.5, fontface = "bold", vjust = -0.5)
print(p10)
ggsave("areatj_plot_adjusted.png", plot = p10, width = 7, height = 5, dpi = 300)
