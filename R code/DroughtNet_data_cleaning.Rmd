...
data <- read_csv("C:/Users/User/Desktop/Durin_data/output/DURIN_clean.csv", 
...
# Rearrange columns to insert mean_thickness at the correct position
droughtnet_data <- droughtnet_data[, c(1:(col_index-1), ncol(droughtnet_data), (col_index):(ncol(droughtnet_data)-1))]

# Now, actually assign the calculated mean thickness values to the new column
...
#so the reassigning will use Siri's original plot numbers 
