...
view(calluna_data)  # Displays "calluna_data" 
...
view(count_per_plot)  # Displays the summarized data for 'DURIN_plot'
...
# Expand the list of envelope IDs for detailed inspection
...
expanded_envelope_ids <- few_envelope_details %>%
  unnest(envelope_ids)
View(expanded_envelope_ids)  # View each individual envelope ID
