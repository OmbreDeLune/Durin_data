...
data <- read_csv("C:/Users/User/Desktop/Durin_data/raw_data/DURIN_clean.csv", guess_max = Inf)# guess_max = Inf' helps in correctly guessing the column types for all rows.
View(data)
